  ...
  <div class="col-sm-12">
    <div class="panel panel-default card-view">
      <div class="panel-heading">
        <div class="pull-left">
          <h6 class="panel-title txt-dark">Driver Order List (Driver)</h6>
        </div>
              ...
              <table id="myTable1" class="table table-hover display  pb-30">
                ...
                <tbody>
                  <?php foreach ($orders as $order) : 
                    if($order->status == 'Waiting for Quotation' || $order->driver_id == $loggedDriverData['driver_id']){
                    ?>
                    <tr class="text-center">
                      <td><a href="<?= site_url('driver/driverOrderList/edit/') . $order->order_id ?>"><i class="fa fa-eye"></i><br><span>Update</span></a></td>
