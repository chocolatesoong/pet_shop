            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-wrap">
                                <form action="<?= base_url('admin/feature/update/' . $feature->feature_id) ?>" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    <input type="hidden" name="_method" value="PUT" />
                                    <div class="form-body">
                                        <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-carousel mr-10"></i>feature's Info</h6>
                                        <hr class="light-grey-hr" />
                                        <center>
                                            <img src="<?= base_url($feature->pic); ?>" width="300" alt="">
                                        </center>
                                        <br>
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="title" id="new_title" placeholder="Enter Title" value="<?= old('title') ? old('title') : $feature->title ?>" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="description" id="new_description" placeholder="Enter description" value="<?= old('title') ? old('description') : $feature->description ?>" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label col-md-4">New feature Image: (Optional)</label>
                                                    <center>
                                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <a href="<?= base_url('admin/feature'); ?>" class="btn btn-default">Back</a>
                                                    </div>
                                                </div>
                                            </div>
