        ...
        <div class="panel panel-default card-view">
            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="form-wrap">
                        <form action="/driver/checkLogin" method="POST" autocomplete="off">
                            <?= csrf_field(); ?>
                            <div class="form-group">
                                <label class="control-label mb-10" for="username"><strong>Driver Username* </strong></label>
                                <div class="input-group mb-0">
                                    <div class="input-group-addon"><i class="icon-user"></i></div>
                                    <input type="text" name="username" class="form-control" id="username" placeholder="Enter Username" value="<?= old('email'); ?>" required>
                                </div>
                                <p class="text-danger mb-3"><?= $validation->getError('username'); ?></p>
                            </div>
                            <div class="form-group">
